...
Welcome to the **Crosschain AAA WEB3 Shooter Game with AI NFT Avatars on Oasys Chain** GitHub repository! This repository contains the Unity game project along with the smart contracts used in the game. Interactive AI NFT Avatars is an exciting 3D game where players use NFT avatars, complete quests, collect diamonds, and explore magical worlds.

## Project Setup

To set up the Interactive AI NFT Avatars on Oasys Chain project, please follow these steps:

1. Clone the repository to your local machine using the following command:
   ```
   git clone https://github.com/andreykobal/simple-nft-minter.git
   ```
...
6. Configure the Metamask wallet by connecting it to the Oasys network and obtaining the necessary testnet tokens [Klaytn Docs](https://docs.klaytn.foundation/) 
...
* Deploy with `npx hardhat run --network oasys scripts/deploy721.js` for ERC-721
* Deploy with `npx hardhat run --network oasys scripts/deploy1155.js` for ERC-1155
* Mint 721 with `npx hardhat run --network oasys scripts/mint.js`
* Mint 1155 with `npx hardhat run --network oasys scripts/mint1155.js`
* Check balance of ERC-1155 with `npx hardhat run --network oasys scripts/balances.js`
* Get metadata of ERC-721 with `npx hardhat run --network oasys scripts/getTokensOfOwner.js`
...
async public void mintItem(int avatarIndex)
{
    ...
    var provider = new JsonRpcProvider("https://rpc.testnet.oasys.games");
...
{
    string contractAbi = "";
    string contractAddress = "0x6721De8B1865A6cD98C64165309372B1f28B95e4";
